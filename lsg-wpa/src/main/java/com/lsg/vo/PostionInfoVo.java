...
public class PostionInfoVo {
	...
	public String getPostionAddr() {
		return postionAddr;
	}

	public void setPostionAddr(String postionAddr) {
		this.postionAddr = postionAddr;
	}
	...
	public void setPostionWelfare(String postionWelfare) {
		this.postionWelfare = postionWelfare;
	}
